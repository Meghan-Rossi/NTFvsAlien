...
GLOBAL_LIST_INIT(specialist_gear_listed_products, list(
	...
	/obj/effect/supply_drop/heavy_armor = list(CAT_SPSUP, "Heavy Armor Pack", 40, "orange"),
	...
	/obj/item/clothing/glasses/thermal/m64_thermal_goggles = list(CAT_SPSUP, "M64 Thermal Goggles", 20, "black"),
	...
	/obj/item/storage/box/crate/loot/thermobaric_pack_spec = list(CAT_SPSUP, "Thermobaric Pack (1 Launcher + RPG bag + 20 Arrays)", 15, "black"),
	...
	/obj/item/storage/box/crate/m42c_system_Jungle  = list(CAT_SPSUP, "Anti Material Pack (AMR + Mixed Ammo + Thermals)", 35, "black"),
	...
	/obj/item/ammo_magazine/rifle/standard_spottingrifle/highimpact = list(CAT_SPSUP, "SG-153 Spotting Rifle High Impact Magazine", 1, "black"),
	/obj/item/ammo_magazine/rifle/standard_spottingrifle/heavyrubber = list(CAT_SPSUP, "SG-153 Spotting Rifle Heavy Rubber Magazine", 1, "black"),
	/obj/item/ammo_magazine/rifle/standard_spottingrifle/tungsten = list(CAT_SPSUP, "SG-153 Spotting Rifle Tungsten Magazine", 1, "black"),
	/obj/item/ammo_magazine/rifle/standard_spottingrifle/flak = list(CAT_SPSUP, "SG-153 Spotting Rifle Flak Magazine", 1, "black"),
	/obj/item/ammo_magazine/rifle/standard_spottingrifle/plasmaloss = list(CAT_SPSUP, "SG-153 Spotting Rifle Tanglefoot Magazine", 1, "black"),
	/obj/item/ammo_magazine/rifle/standard_spottingrifle/incendiary = list(CAT_SPSUP, "SG-153 Spotting Rifle Incendiary Magazine", 1, "black"),
...
GLOBAL_LIST_INIT(vanguard_gear_listed_products, list(
	...
	/obj/item/storage/box/crate/loot/targetrifle_pack_spec = list(CAT_CDSUP, "SG-62 Target Rifle (SG-153 + Mixed Ammo) Pack", 10, "black"),
	...
	/obj/item/ammo_magazine/rifle/standard_spottingrifle/highimpact = list(CAT_CDSUP, "SG-153 Spotting Rifle High Impact Magazine", 1, "black"),
	/obj/item/ammo_magazine/rifle/standard_spottingrifle/heavyrubber = list(CAT_CDSUP, "SG-153 Spotting Rifle Heavy Rubber Magazine", 1, "black"),
	/obj/item/ammo_magazine/rifle/standard_spottingrifle/tungsten = list(CAT_CDSUP, "SG-153 Spotting Rifle Tungsten Magazine", 1, "black"),
	/obj/item/ammo_magazine/rifle/standard_spottingrifle/flak = list(CAT_CDSUP, "SG-153 Spotting Rifle Flak Magazine", 1, "black"),
	/obj/item/ammo_magazine/rifle/standard_spottingrifle/plasmaloss = list(CAT_CDSUP, "SG-153 Spotting Rifle Tanglefoot Magazine", 1, "black"),
	/obj/item/ammo_magazine/rifle/standard_spottingrifle/incendiary = list(CAT_CDSUP, "SG-153 Spotting Rifle Incendiary Magazine", 1, "black"),
...
GLOBAL_LIST_INIT(synthetic_clothes_listed_products, list(
		...
		/obj/item/clothing/suit/storage/RO = list(CAT_SMR, "NTF RO Jacket", 0, "synth-cosmetic"),
		...
		/obj/item/clothing/head/modular/style/cap = list(CAT_SHN, "NTF cap", 0, "synth-rcmarmstorage"),
