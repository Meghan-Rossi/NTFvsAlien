...
/obj/item/explosive/grenade/smokebomb/neuro
	...
	desc = "A smoke grenade containing a concentrated neurotoxin developed by Ninetails, supposedly derived from xenomorphs. Banned in some sectors as a chemical weapon, but classed as a less lethal riot control tool by the NTF."
...
/obj/item/explosive/grenade/smokebomb/acid
	...
	desc = "A grenade set to release a cloud of extremely acidic smoke developed by Ninetails, supposedly derived from xenomorphs. Has a shiny acid resistant shell. Its use is considered a warcrime under several treaties, none of which Ninetails is a signatory to."
