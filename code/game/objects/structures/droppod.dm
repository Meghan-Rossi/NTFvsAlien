...
/obj/structure/droppod/nonmob/mech_pod
	...
	desc = "A menacing metal hunk of steel that is used by the NTF for quick tactical redeployment. This is a larger model designed specifically to carry mechs. Shift click to enter when inside a mech."
